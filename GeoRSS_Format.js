...
/**
 * Class: OpenLayers.Format.GeoRSSJDT
 * Read/write GeoRSS parser. Create a new instance with the 
 *     <OpenLayers.Format.GeoRSSJDT> constructor.
 *
 * Inherits from:
 *  - <OpenLayers.Format.XML>
 */
OpenLayers.Format.GeoRSSJDT = OpenLayers.Class(OpenLayers.Format.XML, {
    ...
    /**
     * Constructor: OpenLayers.Format.GeoRSSJDT
    ...
    createGeometryFromItem: function(item) {
        ...
        var lat = this.getElementsByTagNameNS(item, 
												this.geons, 
												'lat');
												
        var lon = this.getElementsByTagNameNS(item, 
												this.geons, 
												'long');
...
//        debugger;        
    ...
    CLASS_NAME: "OpenLayers.Format.GeoRSSJDT" 
});     
