...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function GetXMLElement(root, name)
{
    for (var o in root)
    {   
        var element = RemoveNS(o);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// class:  global
// function: GetXMLChildElement
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function GetXMLChildElement(root, name)
{
    for (var _o in root)
    {
        var obj = root[_o];
        return GetXMLElement(obj, name);
    }
    debugger;
    return null;
}
...
// function: FindString
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function FindString(sText, sFind)
{
    if (sText.toLowerCase().indexOf(sFind.toLowerCase()) == -1)
        return false;
    else
        return true;
}
