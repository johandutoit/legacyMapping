 ...
 * @xtype datefield
 */
Ext.form.ClearDateField = Ext.extend(Ext.form.TwinTriggerField,  {
    /**
     * @cfg {String} format
...
disabledDates: ["^03"]
    ...
    initComponent : function(){
        Ext.form.ClearDateField.superclass.initComponent.call(this);

        this.addEvents(
            /**
             * @event select
             * Fires when a date is selected via the date picker.
             * @param {Ext.form.ClearDateField} this
    ...
    initEvents: function() {
        Ext.form.ClearDateField.superclass.initEvents.call(this);
    ...
    getErrors: function(value) {
        var errors = Ext.form.ClearDateField.superclass.getErrors.apply(this, arguments);
    ...
    // private
    // Provides logic to override the default TwinTriggerField.validateBlur which just returns true
     ...
     */
    getValue : function(){
        return this.parseDate(Ext.form.ClearDateField.superclass.getValue.call(this)) || "";
    },
...
ClearDateField.setValue(dt);

//Pass a date string (default format):
ClearDateField.setValue('05/04/2006');

//Pass a date string (custom format):
ClearDateField.format = 'Y-m-d';
ClearDateField.setValue('2006-05-04');
</code></pre>
     * @param {String/Date} date The date or valid date string
     * @return {Ext.form.Field} this
     */
    setValue : function(date){
        return Ext.form.ClearDateField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        Ext.form.ClearDateField.superclass.onDestroy.call(this);
    },
    ...
    /**
     * @method onTrigger2Click
     * @hide
     */
    // private
    // Implements the default empty TwinTriggerField.onTrigger2Click function to display the DatePicker
...
Ext.reg('ClearDateField', Ext.form.DateField);